    ...
    switch (SPIControlProtocolState)
    {
        ...
        case startOfControlFrame:
           ...
           // }
            ...
            if (spiMessageCounter == (NUMBER_OF_CONTROL_INPUT_WORDS - 1)) //which is normally 3
            {
              ...
              // positionBuffer=tempPosition;
                ...
                //current
                //spiControlStreamOutput.actualCurrent=0xAAAA; //getFilteredMotorCurrent(); //TODO REMOVE TEST DATA
                ...
                // while ((C1TR01CONbits.TXREQ1)&&(C1INTFbits.TXBP==0)&&(C1INTFbits.TXBO==0));
